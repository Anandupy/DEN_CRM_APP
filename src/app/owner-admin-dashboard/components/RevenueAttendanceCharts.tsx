...
const monthlyRevenueData = [
  { month: 'Nov', revenue: 218000, target: 250000 },
  { month: 'Dec', revenue: 241000, target: 250000 },
  { month: 'Jan', revenue: 196000, target: 260000 },
  { month: 'Feb', revenue: 267000, target: 260000 },
  { month: 'Mar', revenue: 253000, target: 270000 },
  { month: 'Apr', revenue: 284000, target: 280000 },
];

const dailyAttendanceData = [
  { day: '03 Apr', present: 121, absent: 126 },
  { day: '04 Apr', present: 134, absent: 113 },
  { day: '05 Apr', present: 118, absent: 129 },
  { day: '06 Apr', present: 142, absent: 105 },
  { day: '07 Apr', present: 129, absent: 118 },
  { day: '08 Apr', present: 155, absent: 92 },
  { day: '09 Apr', present: 138, absent: 109 },
];
...
export default function RevenueAttendanceCharts() {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={monthlyRevenueData} barCategoryGap="30%" barGap={4}>
            <defs>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
        ...
        <div className="flex items-center justify-between mt-3 pt-3 border-t border-zinc-800">
          <span className="text-xs text-zinc-500">Today&apos;s rate: 55.9%</span>
          <span className="text-xs text-emerald-400 font-medium">↑ Best day this week: Wed (62.7%)</span>
        </div>
      </div>
    </div>
  );
